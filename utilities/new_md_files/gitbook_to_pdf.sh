...
GITBOOK_REP="/Users/laser/Dropbox/Articles/Article_Gits/Survey_of_Alternative_Displays_gitbook/utilities/new_md_files"
  ...
  if [ -f "$SUMMARY_FILE" ]; then
    ...
    pandoc $SUMMARY_FILE -t html | \
      ...
      pandoc -f markdown --variable fontsize=10pt \
              ...
              --resource-path="/Users/laser/Dropbox/Articles/Article_Gits/Survey_of_Alternative_Displays_gitbook/utilities/new_md_files:/Users/laser/Dropbox/Articles/Article_Gits/Survey_of_Alternative_Displays_gitbook/.gitbook/assets:/Users/laser/Dropbox/Articles/Article_Gits/Survey_of_Alternative_Displays_gitbook/utilities/video_embed_images" \
